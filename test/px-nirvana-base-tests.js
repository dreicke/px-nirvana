...
function runBaseTests() {
  px_nirvana_1 = document.getElementById('px_nirvana_1');

  suite('Base Automation Tests for px-nirvana', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-nirvana fixture is created', function() {
      assert.isTrue(document.getElementById('px_nirvana_1') !== null);
    });
